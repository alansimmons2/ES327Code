...
mySketch2.rectangle(point1=(5.0,0.83), point2=(6.6,0.99))
mySketch2.rectangle(point1=(3.4,0.57), point2=(5.0,0.73))
mySketch2.rectangle(point1=(5.0,0.29), point2=(6.6,0.45))
mySketch2.rectangle(point1=(3.4,0.01), point2=(5.0,0.17))
...
mySketch3.rectangle(point1=(4.9,0.82), point2=(6.7,0.999))
mySketch3.rectangle(point1=(3.3,0.56), point2=(5.1,0.74))
mySketch3.rectangle(point1=(4.9,0.28), point2=(6.7,0.46))
mySketch3.rectangle(point1=(3.3,0.001), point2=(5.1,0.18))
...
IPMaterial.Diffusivity(table=((0.005,0.0),))
...
Matregion = myPart.Set(faces=myPart.faces.getSequenceFromMask(('[#f ]',),), name='Set-1')
...
NPregion = myPart2.Set(faces=myPart2.faces.getSequenceFromMask(('[#f]',),), name='Set-1')
...
IPregion = myPart.Set(faces=myPart.faces.getSequenceFromMask(('[#f]',),), name='Set-1')
...
# myModel.parts['NCPI'].Set(faces=myModel.parts['NCPI'].faces.getSequenceFromMask(('[#f]',),), name='Set-2')
...
# myModel.parts['NCPI'].Set(faces=myModel.parts['NCPI'].faces.getSequenceFromMask(('[#2e]',),), name='Set-3')
...
# myModel.parts['NCPI'].Set(faces=myModel.parts['NCPI'].faces.getSequenceFromMask(('[#1]',),), name='Set-4')
...
myModel.parts['NCPI'].Set(faces=myModel.parts['NCPI'].faces.getSequenceFromMask(('[#1 ]', ), ), name='Set-5')
myModel.parts['NCPI'].SectionAssignment(offset=0.0, offsetField='', offsetType=MIDDLE_SURFACE, region=myModel.parts['NCPI'].sets['Set-5'], sectionName='MatSec', thicknessAssignment=FROM_SECTION)
myModel.parts['NCPI'].Set(faces=myModel.parts['NCPI'].faces.getSequenceFromMask(('[#1e ]', ), ), name='Set-6')
myModel.parts['NCPI'].SectionAssignment(offset=0.0, offsetField='', offsetType=MIDDLE_SURFACE, region=myModel.parts['NCPI'].sets['Set-6'], sectionName='IPSec', thicknessAssignment=FROM_SECTION)
myModel.parts['NCPI'].Set(faces=myModel.parts['NCPI'].faces.getSequenceFromMask(('[#1e0 ]', ), ), name='Set-7')
myModel.parts['NCPI'].SectionAssignment(offset=0.0, offsetField='', offsetType=MIDDLE_SURFACE, region=myModel.parts['NCPI'].sets['Set-7'], sectionName='NPSec', thicknessAssignment=FROM_SECTION)
