...
myModel.sketches['__profile__'].rectangle(point1=(0.0,0.0),point2=(4.0,4.0))
...
# NP Creation
myModel.ConstrainedSketch(name='__profile__', sheetSize=200.0) 
myModel.sketches['__profile__'].rectangle(point1=(2-halflw,2-halflw),point2=(2+halflw,2+halflw))
...
myModel.rootAssembly.translate(instanceList=('NP-1', ), vector=(translatorxy, translatorxy, translatorz))
...
myModel.rootAssembly.Set(faces=myModel.rootAssembly.instances['NanComp-1'].faces.getSequenceFromMask(('[#10 ]', ), ), name='Set-3')
...
myModel.rootAssembly.Set(faces=myModel.rootAssembly.instances['NanComp-1'].faces.getSequenceFromMask(('[#20 ]', ), ), name='Set-4')
