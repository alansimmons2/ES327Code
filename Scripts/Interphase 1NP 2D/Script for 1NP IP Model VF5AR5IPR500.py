...
mySketch2.rectangle(point1=(0.25,0.45), point2=(0.75,0.55))
...
mySketch3.rectangle(point1=(0.225,0.425), point2=(0.775,0.575))
...
mdb.models['MM'].sketches['__profile__'].Line(point1=(-0.275, 0.075), point2=(
    -0.5, 0.075))
...
mdb.models['MM'].sketches['__profile__'].Line(point1=(-0.25, -0.05), point2=(
    -0.275, -0.075))
...
mdb.models['MM'].sketches['__profile__'].ParallelConstraint(addUndoState=False, 
    ...
    mdb.models['MM'].sketches['__profile__'].geometry[47])
mdb.models['MM'].sketches['__profile__'].CoincidentConstraint(addUndoState=
...
mdb.models['MM'].sketches['__profile__'].Line(point1=(0.25, -0.05), point2=(
    0.25, -0.0749999999767169))
mdb.models['MM'].sketches['__profile__'].VerticalConstraint(addUndoState=False, 
    entity=mdb.models['MM'].sketches['__profile__'].geometry[48])
mdb.models['MM'].sketches['__profile__'].PerpendicularConstraint(addUndoState=
    False, entity1=mdb.models['MM'].sketches['__profile__'].geometry[30], 
    entity2=mdb.models['MM'].sketches['__profile__'].geometry[48])
mdb.models['MM'].sketches['__profile__'].CoincidentConstraint(addUndoState=
...
mdb.models['MM'].sketches['__profile__'].Line(point1=(0.25, -0.05), point2=(
    0.274999999953434, -0.05))
mdb.models['MM'].sketches['__profile__'].HorizontalConstraint(addUndoState=
    False, entity=mdb.models['MM'].sketches['__profile__'].geometry[49])
mdb.models['MM'].sketches['__profile__'].ParallelConstraint(addUndoState=False, 
    entity1=mdb.models['MM'].sketches['__profile__'].geometry[30], entity2=
    mdb.models['MM'].sketches['__profile__'].geometry[49])
mdb.models['MM'].sketches['__profile__'].CoincidentConstraint(addUndoState=
...
mdb.models['MM'].sketches['__profile__'].ParallelConstraint(addUndoState=False, 
    ...
    mdb.models['MM'].sketches['__profile__'].geometry[50])
mdb.models['MM'].sketches['__profile__'].CoincidentConstraint(addUndoState=
...
mdb.models['MM'].sketches['__profile__'].PerpendicularConstraint(addUndoState=
    ...
    entity2=mdb.models['MM'].sketches['__profile__'].geometry[51])
mdb.models['MM'].sketches['__profile__'].CoincidentConstraint(addUndoState=
