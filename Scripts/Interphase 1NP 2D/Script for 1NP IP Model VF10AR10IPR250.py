...
mySketch3.rectangle(point1=(3.379332699,0.3023576463), point2=(6.620667301,0.6976423538))
...
IPMaterial.Diffusivity(table=((0.0001,0.0),))
...
mdb.models['MM'].ConstrainedSketch(gridSpacing=0.5, name='__profile__', 
    ...
    mdb.models['MM'].parts['NCPI'].MakeSketchTransform(
    sketchPlane=mdb.models['MM'].parts['NCPI'].faces[2], sketchPlaneSide=SIDE1, 
    sketchOrientation=RIGHT, origin=(5.0, 0.5, 0.0)))
mdb.models['MM'].parts['NCPI'].projectReferencesOntoSketch(filter=
    COPLANAR_EDGES, sketch=mdb.models['MM'].sketches['__profile__'])
mdb.models['MM'].sketches['__profile__'].Line(point1=(-1.620667301, 
    0.1976423538), point2=(-5.0, 0.1976423538))
...
mdb.models['MM'].sketches['__profile__'].Line(point1=(-1.620667301, 
    -0.1976423537), point2=(-5.0, -0.1976423537))
mdb.models['MM'].sketches['__profile__'].HorizontalConstraint(addUndoState=
...
mdb.models['MM'].sketches['__profile__'].CoincidentConstraint(addUndoState=
    False, entity1=mdb.models['MM'].sketches['__profile__'].vertices[15], 
    entity2=mdb.models['MM'].sketches['__profile__'].geometry[19])
mdb.models['MM'].parts['NCPI'].PartitionFaceBySketch(faces=
...
mdb.models['MM'].ConstrainedSketch(gridSpacing=0.5, name='__profile__', 
    sheetSize=20.09, transform=
    mdb.models['MM'].parts['NCPI'].MakeSketchTransform(
    sketchPlane=mdb.models['MM'].parts['NCPI'].faces[3], sketchPlaneSide=SIDE1, 
    sketchOrientation=RIGHT, origin=(5.0, 0.5, 0.0)))
mdb.models['MM'].parts['NCPI'].projectReferencesOntoSketch(filter=
    COPLANAR_EDGES, sketch=mdb.models['MM'].sketches['__profile__'])
mdb.models['MM'].sketches['__profile__'].Line(point1=(-1.58113883, 0.158113883)
    , point2=(-1.58113883, 0.197642353814498))
...
mdb.models['MM'].sketches['__profile__'].Line(point1=(-1.58113883, 
    -0.158113883), point2=(-1.58113883, -0.197642353648083))
mdb.models['MM'].sketches['__profile__'].VerticalConstraint(addUndoState=False, 
...
mdb.models['MM'].sketches['__profile__'].CoincidentConstraint(addUndoState=
    ...
    entity2=mdb.models['MM'].sketches['__profile__'].geometry[22])
mdb.models['MM'].sketches['__profile__'].Line(point1=(1.58113883, -0.158113883)
    , point2=(1.58113883, -0.197642353648083))
mdb.models['MM'].sketches['__profile__'].VerticalConstraint(addUndoState=False, 
...
mdb.models['MM'].sketches['__profile__'].CoincidentConstraint(addUndoState=
    ...
    entity2=mdb.models['MM'].sketches['__profile__'].geometry[7])
mdb.models['MM'].parts['NCPI'].PartitionFaceBySketch(faces=
    mdb.models['MM'].parts['NCPI'].faces.getSequenceFromMask(('[#8 ]', ), ), 
    sketch=mdb.models['MM'].sketches['__profile__'])
del mdb.models['MM'].sketches['__profile__']
