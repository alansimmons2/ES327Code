...
mySketch3.rectangle(point1=(0.128735,0.446925), point2=(0.871265,0.553215))
...
mdb.models['MM'].ConstrainedSketch(gridSpacing=0.07, name='__profile__', 
    ...
    sketchPlaneSide=SIDE1, sketchOrientation=RIGHT, origin=(0.5, 0.499994, 
    0.0)))
mdb.models['MM'].rootAssembly.projectReferencesOntoSketch(filter=COPLANAR_EDGES
    , sketch=mdb.models['MM'].sketches['__profile__'])
mdb.models['MM'].sketches['__profile__'].Line(point1=(-0.371265, 0.053221), 
    point2=(-0.5, 0.053221))
...
mdb.models['MM'].sketches['__profile__'].Line(point1=(-0.371265, -0.053069), 
    point2=(-0.5, -0.053069))
mdb.models['MM'].sketches['__profile__'].HorizontalConstraint(addUndoState=
...
mdb.models['MM'].sketches['__profile__'].Line(point1=(-0.35355, 0.03543), 
    point2=(-0.35355, 0.0531450000062957))
...
mdb.models['MM'].rootAssembly.seedPartInstance(deviationFactor=0.1, 
    ...
    mdb.models['MM'].rootAssembly.instances['NCPI-1'], ), size=0.001)
mdb.models['MM'].rootAssembly.seedPartInstance(deviationFactor=0.1, 
    minSizeFactor=0.1, regions=(
