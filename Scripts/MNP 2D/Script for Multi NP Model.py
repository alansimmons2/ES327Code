...
mySketch2.rectangle(point1=(3.4,0.684), point2=(5.0,0.844))
mySketch2.rectangle(point1=(5.0,0.508), point2=(6.6,0.668))
mySketch2.rectangle(point1=(3.4,0.332), point2=(5.0,0.492))
mySketch2.rectangle(point1=(5.0,0.156), point2=(6.6,0.316))
...
myModel.parts['NanCompSec'].Set(faces=myModel.parts['NanCompSec'].faces.getSequenceFromMask(('[#1]',),), name='Set-2')
...
myModel.parts['NanCompSec'].Set(faces=myModel.parts['NanCompSec'].faces.getSequenceFromMask(('[#1e]',),), name='Set-3')
