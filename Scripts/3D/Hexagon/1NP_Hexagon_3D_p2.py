...
# NP Creation
myModel.ConstrainedSketch(name='__profile__', sheetSize=200.0)
myModel.sketches['__profile__'].Line(point1=(11.500, 6.0), point2=(9.750, 9.25))
myModel.sketches['__profile__'].Line(point1=(9.750, 9.25), point2=(2.250, 9.25))
myModel.sketches['__profile__'].Line(point1=(2.250, 9.25), point2=(0.500, 6.0))
myModel.sketches['__profile__'].Line(point1=(0.500, 6.0), point2=(2.250, 2.75))
myModel.sketches['__profile__'].Line(point1=(2.250, 2.75), point2=(9.750, 2.75))
myModel.sketches['__profile__'].Line(point1=(9.750, 2.75), point2=(11.500, 6.0))
...
myModel.rootAssembly.translate(instanceList=('NP-1', ), vector=(0.0, 0.0, 0.5-(dep/2)))
