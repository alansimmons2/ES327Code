...
mySketch.rectangle(point1=(0.0, 0.0), point2=(100.0, 1.0))
...
mySketch2.rectangle(point1=(34.0,0.34), point2=(66.0,0.66))
...
rightEdge = myModel.rootAssembly.instances['NanCompSec-1'].edges.findAt(((100.0, 0.5, 0.0),))
leftEdge = myModel.rootAssembly.instances['NanCompSec-1'].edges.findAt(((0.0, 0.5, 0.0),))
topEdge = myModel.rootAssembly.instances['NanCompSec-1'].edges.findAt(((50.0, 1.0, 0.0),))
bottomEdge = myModel.rootAssembly.instances['NanCompSec-1'].edges.findAt(((50.0, 0.0, 0.0),))
